...
from .views import DeleteNotificationsView,SettingWithDrawalAccount,FetchWithdrawalAccount,DeleteWithdrawalAccount
from .trx_views import SendMoneyView,WithdrawalView,WithdrawalRequestView
urlpatterns = [
    ...
    path('delete_withdrowal_acc/<int:account_id>/', DeleteWithdrawalAccount.as_view(),name='delete-withdrawal-account'),
