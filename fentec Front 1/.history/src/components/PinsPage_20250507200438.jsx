...
const PinsPage = ({toggleInsertPin,insertPinAction = null,digit = '4',title='Enter Your Pin'}) => {
    ...
    return ( 
        <div className=" pay-page confirm-payment-plate " >
                <div className="c-text">{digit === '4'? `${title}` : 'Enter Otp Sent to your Email'}</div>
                ...
                {<div className=" select-account show-pin flex">
                            <input type="password" className ="pin-di" id="pin-dig-1" maxLength="1"  ref={pwd1} autoFocus 
                                onChange={(e) => {
                                    pinClicked(e);
                        }}
                            />
