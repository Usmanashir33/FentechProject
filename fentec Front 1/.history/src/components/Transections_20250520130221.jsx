...
const Transactions = () => {
    ...
    const {CalenderDisplayer, CalenderScreen, handleDateSelection, setDisplayFilter, displayFselectedDate} = useCalenderFilterer(transections?.results,setFilteredTrxs);
