            ...
            <div key={withdrawal.id} className="withdrawal-card hover-effect">
                ...
                <div className="flex justify-between">
                    ...
                    <div className="card-actions">
                        <button className="cancel-button" name="cancel" onClick={(e) => {buttonClicked(e)}}>Cancel</button>
                        <button className="approve-button" name="approve" onClick={(e) => {buttonClicked(e)}}>Approve</button>
                    </div>
                </div>
