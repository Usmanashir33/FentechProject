        ...
        <div className="transection-section ">
                            ...
                            {displayFilter && <div className="filter-container">
                                ...
                                <div className="sel-days">
                                    <div className={``} onClick={() => {handleDateSelection('today', transections)}}>Today</div>
                                    <div className={``} onClick={() => {handleDateSelection('yesterday', transections)}}>Yesterday</div>
                                    <div className={``} onClick={() => {handleDateSelection('thisWeek', transections)}}>This Week</div>
                                    <div className={``} onClick={() => {handleDateSelection('lastWeek', transections)}}>Last Week</div>
                                    <div className={``} onClick={() => {handleDateSelection('thisMonth', transections)}}>This Month</div>
                                    <div className={``} onClick={() => {handleDateSelection('lastMonth', transections)}}>Last Month</div>
                                    <div className={``} onClick={() => {handleDateSelection('clear', transections)}}>Clear</div>
