        ...
        <div className="transection-section ">
                            ...
                            {displayFilter && <div className="filter-container">
                                ...
                                <div className="sel-days">
                                    <div className={``} onClick={() => {handleDateSelection('today', tr)}}>Today</div>
                                    <div className={``} onClick={() => {handleDateSelection('yesterday', tr)}}>Yesterday</div>
                                    <div className={``} onClick={() => {handleDateSelection('thisWeek', tr)}}>This Week</div>
                                    <div className={``} onClick={() => {handleDateSelection('lastWeek', tr)}}>Last Week</div>
                                    <div className={``} onClick={() => {handleDateSelection('thisMonth', tr)}}>This Month</div>
                                    <div className={``} onClick={() => {handleDateSelection('lastMonth', tr)}}>Last Month</div>
                                    <div className={``} onClick={() => {handleDateSelection('clear', tr)}}>Clear</div>
