        ...
        <div className="transection-section ">
                            ...
                            <div className="filter-container">
                                ...
                                <div className="sel-days">
                                    <div className={``} onClick={() => {handleDateSelection('')}}>Today</div>
                                    <div className={``} onClick={() => {handleDateSelection('')}}>Yesterday</div>
                                    <div className={``} onClick={() => {handleDateSelection('')}}>Last Week</div>
                                    <div className={``} onClick={() => {handleDateSelection('')}}>Last Month</div>
                                    <div className={``} onClick={() => {handleDateSelection('')}}>Clear</div>
                                    <div className={`flex`} onClick={handleCustomClick}>
                                        custom
                                        <input type='date' name="" id="date"  className="" ref={calender} onClick={() => {
                                            handleDateSelection(e.target.val)
                                        }}/>
                                    </div>
                                </div>
                            </div>
