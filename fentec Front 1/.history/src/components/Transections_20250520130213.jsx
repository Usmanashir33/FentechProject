...
const Transactions = () => {
    ...
    const {CalenderDisplayer, CalenderScreen, handleDateSelection, setDisplayFilter, displayFilter, selectedDate} = useCalenderFilterer(transections?.resul,setFilteredTrxs);
