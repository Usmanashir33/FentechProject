        ...
        <div className="transection-section ">
                            ...
                            <div className="filter-container">
                                ...
                                <div className="sel-days">
                                    <div className={``} onClick={arr}>Today</div>
                                    <div className={``} onClick={arr}>Yesterday</div>
                                    <div className={``} onClick={arr}>Last Week</div>
                                    <div className={``} onClick={arr}>Last Month</div>
                                    <div className={``} onClick={arr}>Clear</div>
