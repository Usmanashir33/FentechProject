        ...
        <div className="transection-section ">
                            ...
                            <div className="filter-container">
                                ...
                                <div className="sel-days">
                                    <div className={``} onClick={}>Today</div>
                                    <div className={``} onClick={}>Yesterday</div>
                                    <div className={``} onClick={}>Last Week</div>
                                    <div className={``} onClick={}>Last Month</div>
                                    <div className={``} onClick={}>Clear</div>
