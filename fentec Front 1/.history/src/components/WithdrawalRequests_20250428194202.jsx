            ...
            <div key={withdrawal.id} className="withdrawal-card hover-effect">
                ...
                <div className="flex justify-between">
                    ...
                    <div className="card-actions">
                        <button className="cancel-button" name="cancel" onClick={(e) => {buttonClicked}}>Cancel</button>
                        <button className="approve-button" name="cancel" onClick={(e) => {buttonClicked}}>Approve</button>
                    </div>
                </div>
