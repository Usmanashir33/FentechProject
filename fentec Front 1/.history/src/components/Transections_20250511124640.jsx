...
const Transactions = () => {
    ...
    const refetch = (refetch_mode) => {
        let link_next = transections?.next; // default\
        let link_previous = transections?.previous; // default\
        switch (refetch_mode) {
            case 'next':
                if (link_next){
            ...
            case 'previous':
                if (link_previous){
                    ...
                    let previ = `${url.pathname}${url.search}`;
                    console.log('link: ', previ);
                }
                break;
