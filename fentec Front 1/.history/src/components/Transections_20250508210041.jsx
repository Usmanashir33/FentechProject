        ...
        <div className="transection-section ">
                            ...
                            <div className="filter-container">
                                ...
                                <div className="sel-days">
                                    <div className={``} onClick={arrow}>Today</div>
                                    <div className={``} onClick={arrow}>Yesterday</div>
                                    <div className={``} onClick={arrow}>Last Week</div>
                                    <div className={``} onClick={arrow}>Last Month</div>
                                    <div className={``} onClick={arrow}>Clear</div>
