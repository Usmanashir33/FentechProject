    ...
    const handleDateSelection =(range) => {
            ...
            LastMonth.setMonth(LastMonth.getMonth() - 1);
              ...
              switch (range) {
                ...
                case 'lastWeek':
                    setFilteredTrxs(filteredTrxs.filter(item => {
                        const itemDate = new Date(item.date);
                ...
                case 'lastMonth':
                    return setFilteredTrxs(filteredTrxs.filter(item => {
                        const itemDate = new Date(item.date);
                        return (itemDate >= LastMonth) ? item : null ;
                    }))
                case 'clear':
                    setFilteredTrxs(transections)
                default:
        ...
        <div className="transection-section ">
                            ...
                            {showFilter <div className="filter-container">
                                <div className=" relative">
                                    <FontAwesomeIcon icon={faMultiply} className="cancel" onClick={() => {setShowFilter(false)}}/>
                                </div>
                                <div className="sel-days" onClick={setShowFilter(true)}>
