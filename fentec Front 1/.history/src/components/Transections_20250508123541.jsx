...
const Transactions = () => {
    ...
    return ( 
        <div className="transection-section ">
                            <div className="transection-heade">
