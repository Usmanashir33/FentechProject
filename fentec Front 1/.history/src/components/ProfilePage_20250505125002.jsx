...
const ProfilePage = () => {
  ...
  return (
    <div className="profile-container relati">
      {/* Header */}
      ...
      <header className="profile-header">
        <span onClick={handleChangeImage}>
          ...
          <img src={`${config.BASE_URL}${currentUser?.picture}`} alt={`user pic`} className="user-img-profile" />
          :
       ...
       {updateImage && <UpdateImageForm cancel = {setUpdateImage}/>}
