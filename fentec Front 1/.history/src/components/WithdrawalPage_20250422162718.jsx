...
const WithdrawalPage = () => {
  ...
  const handleSubmit = (e) => { 
    ...
    if (amount > currentUser.account.account_balance) {
      console.log(' currentUser.account.account_balance: ',  currentUser.account.account_balance);
  ...
  const handleDeleteAccResponse = (data) => {
    setPopupText("bank deleted successfully ");
    setShowPopup(true);
  ...
  const handleSaveBankResponse = (data) => {
      setPopupText("New bank added successfully ");
      setShowPopup(true);
  ...
  const handlewithdraw = (payment_pin) => { 
    showPopup("withdrawal request sent successfully")
    setPinDialog3(false);
