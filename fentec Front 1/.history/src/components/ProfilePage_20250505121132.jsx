  ...
  return (
    <div className="profile-container">
      ...
      <header className="profile-header">
        ...
        <div>
          <h1>{currentUser?.first_name? `${currentUser.first_name} ${currentUser.first_name}` : "unverified user"}</h1>
          <p><FontAwesomeIcon icon={faBox}/>  {currentUser.first_name}</p>
          <p><FontAwesomeIcon icon={faPhone}/> {'+234 8166997172'}</p>
        </div>
      </header>
