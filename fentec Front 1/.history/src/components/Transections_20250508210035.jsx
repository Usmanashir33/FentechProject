        ...
        <div className="transection-section ">
                            ...
                            <div className="filter-container">
                                ...
                                <div className="sel-days">
                                    <div className={``} onclic>Today</div>
                                    <div className={``} onclic>Yesterday</div>
                                    <div className={``} onclic>Last Week</div>
                                    <div className={``} onclic>Last Month</div>
                                    <div className={``} onclic>Clear</div>
