...
const Transactions = () => {
    ...
    const {CalenderDisplayer, CalenderScreen, handleDateSelection, setDisplayFilter, displayFilter, selectedDate} = useCalenderFilterer(transections?,setFilteredTrxs);
