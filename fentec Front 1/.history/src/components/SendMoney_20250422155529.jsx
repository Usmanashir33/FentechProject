...
import { faCheckCircle, faHistory, faMultiply } from "@fortawesome/free-solid-svg-icons";
                    ...
                    <div className="navs ">
                        <div className="nav d-nav justify-end">
                            <span className="justify-end">
                                <FontAwesomeIcon icon={faUse} className="nav-icon"/>
