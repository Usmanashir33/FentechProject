...
const WithdrawalRequestsPage = () => {
    ...
    const buttonClicked = (e,trx_selected) => {
      ...
      if (action === "approve") {
        setFormData({ ...formData, approval: true, trx_id: trx_selected.id });
        setPinDialog(true);
            ...
            <div key={withdrawal.id} className="withdrawal-card hover-effect">
                ...
                <div className="flex justify-between">
                    ...
                    <div className="card-actions">
                        <button className="cancel-button" name="cancel" onClick={(e) => {buttonClicked(e,withdrawal.i)}}>Cancel</button>
                        <button className="approve-button" name="approve" onClick={(e) => {buttonClicked(e,withdrawal.i)}}>Approve</button>
                    </div>
                </div>
              <input type="text" value={reason} name="" id="" placeholder="write the reason for cancelation"
