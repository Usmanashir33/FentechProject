        ...
        <div className="transection-section ">
                            ...
                            {displayFilter && <div className="filter-container">
                                ...
                                <div className="sel-days">
                                    <div className={``} onClick={() => {handleDateSelection('today', transections?.results ,)}}>Today</div>
                                    <div className={``} onClick={() => {handleDateSelection('yesterday', transections?.results ,)}}>Yesterday</div>
                                    <div className={``} onClick={() => {handleDateSelection('thisWeek', transections?.results ,)}}>This Week</div>
                                    <div className={``} onClick={() => {handleDateSelection('lastWeek', transections?.results ,)}}>Last Week</div>
                                    <div className={``} onClick={() => {handleDateSelection('thisMonth', transections?.results ,)}}>This Month</div>
                                    <div className={``} onClick={() => {handleDateSelection('lastMonth', transections?.results ,)}}>Last Month</div>
                                    <div className={``} onClick={() => {handleDateSelection('clear', transections?.results ,)}}>Clear</div>
