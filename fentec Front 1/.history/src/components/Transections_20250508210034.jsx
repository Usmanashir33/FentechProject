        ...
        <div className="transection-section ">
                            ...
                            <div className="filter-container">
                                ...
                                <div className="sel-days">
                                    <div className={``} oncli>Today</div>
                                    <div className={``} oncli>Yesterday</div>
                                    <div className={``} oncli>Last Week</div>
                                    <div className={``} oncli>Last Month</div>
                                    <div className={``} oncli>Clear</div>
