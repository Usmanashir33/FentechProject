            ...
            <div key={withdrawal.id} className="withdrawal-card hover-effect">
                ...
                <div className="flex justify-between">
                    <div className="card-info">
                        <div className="bank"><strong>{withdrawal.withdrawal_bank_name}</strong>
                        </div>
                        <div className="account"><strong>{withdrawal.withdrawal_account_number}</strong>
                        </div>
                        <div className="account"><strong>{withdrawal.withdrawal_account_number}
                          </strong></div>
