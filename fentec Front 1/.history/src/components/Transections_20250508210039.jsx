        ...
        <div className="transection-section ">
                            ...
                            <div className="filter-container">
                                ...
                                <div className="sel-days">
                                    <div className={``} onClick={a}>Today</div>
                                    <div className={``} onClick={a}>Yesterday</div>
                                    <div className={``} onClick={a}>Last Week</div>
                                    <div className={``} onClick={a}>Last Month</div>
                                    <div className={``} onClick={a}>Clear</div>
