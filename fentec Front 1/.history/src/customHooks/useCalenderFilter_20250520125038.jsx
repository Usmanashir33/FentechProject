...
const CalenderFilterer = (filteringData,setFilteringData) => {
    const [displayFilter, setDisplayFilter] = useState(false)
    const [selectedDate, setSelectedDate] = useState('All')

    const handleDateSelection =(range,setSelectedDate,setFilteringData) => {
            ...
            setDisplayFilter(false);
              ...
              switch (range) {
                case 'today':
                  return setFilteringData(setSelectedDate.filter(item => {
                    const itemDate = new Date (item.trx_date);
                ...
                case 'clear':
                    setFilteringData(setSelectedDate);
                    setSelectedDate('All')
